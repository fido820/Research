...
\begin{column}{\onecolwid}
	\begin{block}{Implementation}
		...
		\begin{figure}[ht]
			...
			\caption{Kiwi Holonomic Drive Kinematics}
		\end{figure}
	\end{block}
