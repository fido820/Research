...
\begin{column}{\onecolwid}
	...
	\begin{block}{System Overview}
		...
		\begin{enumerate}
			...
			\item Fido employs dynamic sizing of the neural network and experience replay to lower training time.
		\end{enumerate}
	\end{block}
